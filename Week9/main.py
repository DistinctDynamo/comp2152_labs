...
while not input_valid and i in range(5):
    try:
        ...
        print("Exceptions: Invalid input, player needs to enter an integer number for combat strength.")
...
while m_health_points > 0 and health_points > 0:
    ...
    if not (attack_roll % 2 == 0):
        ...
        try:
            ...
            print("Exception: combat_strength and m_health_points both needed to be integers")
    else:
